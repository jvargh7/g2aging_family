...
g_covariates = "+ bmi + ge65 + education_2 + education_3 + laborforce + smoke + heavydrinker + moderate_pa + vigorous_pa + religion + raceethnic"
...
hrs_create_pooled <- function(mice_df){
  
  w_selected = c("w_htn","h_htn","w_bmi","w_ge65","w_education_2", "w_education_3", "w_laborforce", "w_smoke", "w_heavydrinker", "w_moderate_pa", "w_vigorous_pa","w_religion","w_raceethnic")
  h_selected = c("h_htn","w_htn","h_bmi", "h_ge65", "h_education_2", "h_education_3", "h_laborforce", "h_smoke", "h_heavydrinker", "h_moderate_pa", "h_vigorous_pa","h_religion","h_raceethnic")
  hh_selected = c(
    "hhid", # Level 3
...
pooled_1 <- hrs_create_pooled(df_1)
...
bind_rows(
  ...
  write_csv(.,"hrs/g2ah04_poisson regression for gendered differences.csv")
