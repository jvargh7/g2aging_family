w_covariates = "+ w_bmi + w_ge65 + w_education_2 + w_education_3 + w_smoke + w_heavydrinker + 
w_moderate_pa + w_vigorous_pa + w_religion + w_laborforce + w_raceethnic"

h_covariates = "+ h_bmi + h_ge65 + h_education_2 + h_education_3 + h_smoke + h_heavydrinker + 
h_moderate_pa + h_vigorous_pa +h_religion + h_laborforce + h_raceethnic"
...
w4 <- paste0("w_htn ~ h_htn*residence",w_covariates,hh_covariates) %>% str_replace(.,"\\+ residence ","") %>% as.formula()
h4 <- paste0("h_htn ~ w_htn*residence",h_covariates,hh_covariates) %>% str_replace(.,"\\+ residence ","") %>% as.formula()
